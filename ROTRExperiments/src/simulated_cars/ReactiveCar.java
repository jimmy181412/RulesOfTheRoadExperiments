...
public class ReactiveCar extends AbstractROTRCar implements CarEvents{
    ...
    private boolean finished_overtaking_2;
    ...
    public ReactiveCar(Point startPos, Point endPos,Point referencePos, Direction initialDirection, int startingSpeed){
    ...
    public void worldUpdate(WorldSim visibleWorld, Point location) 
    {
        ...
        if(overtaking){
            if(cmd == Direction.north){
                ...
                finished_overtaking = visibleWorld.containsCar( location.getX() - 3, location.getY() - 1)
...
//                    System.out.println("sizr is" +  pointPassing1.size());
            ...
            case CB_onMotorway: //not simulated
                ...
                break;
            case CB_onPavement: //not simulated //the car can not be on pavement
